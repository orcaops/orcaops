...
description: "Two-phase checkpoint lifecycle: open declares scope, close finalizes it (firing checkpoint-close evaluators), abandon cancels it."
metadata:
  generatedBy: "orcaops@0.1.0"
  contentHash: "ffaff1d05ae5"
---
...
field on `orcaops capture plan` (see the orcaops-capture skill); use this
