...
description: "Upload, request reviewers, read, download, approve, or pin a plan through the Orcaops cloud approval flow. Use for \"get this plan approved\", \"is my plan approved yet?\", \"read or download the plan body\", or \"pull the approved plan\"."
metadata:
  generatedBy: "orcaops@0.3.0"
  contentHash: "a98fec0b0d22"
---
