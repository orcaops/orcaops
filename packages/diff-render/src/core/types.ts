// Vendored from hunk (https://github.com/modem-dev/hunk) @ 9ef9b2e, source path src/core/types.ts
// MIT License, Copyright (c) Ben Vinegar. Full text: packages/diff-render/LICENSE.
// Adaptations for @orcaops/diff-render:
//   - The FileSourceFetcher import (from the Bun-runtime ./fileSource) inlined as its extracted provider-neutral interface, keeping this package free of Bun/fs coupling.
