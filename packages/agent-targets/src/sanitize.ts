...
/* eslint-disable no-control-regex -- this is a terminal-escape sanitizer; the regexes intentionally match control characters. Bodies are kept byte-for-byte from upstream. */
