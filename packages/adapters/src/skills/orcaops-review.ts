...
export const orcaopsReviewSkill: SkillTemplate = {
  ...
  description:
    'Handle human feedback on a cloud PR review: check comments, reply to reviewer threads, push fixes, or wait for the reviewer. Use for "address the review feedback on my PR".',
