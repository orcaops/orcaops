...
export const orcaopsDigestSkill: SkillTemplate = {
  ...
  description:
    'Render a reviewer-facing digest for one artifact or a whole branch. Use branch-wide mode for PR summaries and PR bodies; use the default mode for an explicitly named artifact or thread.',
  tags: ['orcaops', 'read'],
