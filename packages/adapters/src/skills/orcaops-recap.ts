...
export const orcaopsRecapSkill: SkillTemplate = {
  ...
  description:
    'Summarize captured work over a time window or git range as a standup, changelog, or journal. Use for "what did I do yesterday?", "changelog since v1.2", "draft the release notes", or "journal today".',
