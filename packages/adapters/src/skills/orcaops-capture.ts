...
export const orcaopsCaptureSkill: SkillTemplate = {
  ...
  description:
    'Capture or revise the plan for a coding task. Initial capture mints stable step_ids and fires post-plan evaluators; revisions are append-only events with full-supersede payloads and fire post-plan-revision evaluators.',
