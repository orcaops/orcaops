 ...
 * the pre-plan prior-art sweep, which asks what the record already requires
 * before it asks what anyone did before, and critiquing a DRAFT plan against
 * past decisions, fragility signals, non-goals, abandoned attempts, and weak
 * acceptance criteria. Drives ONLY existing read commands — knowledge lookup,
 * search, decisions, loose-ends, list --touching, show.
 */
...
\`${skillRef('capture', prefix)}\` skill for the field.
...
\`${skillRef('search', prefix)}\` skill before quoting one back.
