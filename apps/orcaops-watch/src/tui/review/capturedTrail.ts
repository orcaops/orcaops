...
const RECORD_LABEL: Readonly<Record<CitationKind, string>> = {
  ...
  [CITATION_KIND.CRITERION_EVIDENCE]: 'AGENT-REPORTED EVIDENCE',
  [CITATION_KIND.CHECKPOINT_VERIFICATION]: 'AGENT-REPORTED COMMAND',
  ...
  [CITATION_KIND.SUMMARY]: 'AGENT-REPORTED SUMMARY',
