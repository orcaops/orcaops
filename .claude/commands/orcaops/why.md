...
metadata:
  ...
  contentHash: "fe9882096dd5"
tags: ["orcaops", "read-only"]
---

Answer "how did this file evolve?" with its complete captured history,
...
Pair with `/orcaops:show <id>` to read the full artifact for the match;
pair with `/orcaops:digest` for the broader PR picture.
